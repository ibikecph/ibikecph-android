...
public class SMDictionary {
	...
	public static String getDictFile(IBikePreferences.Language language) {
		if (language == IBikePreferences.Language.DAN)
			return "da.strings";
		else
			return "en.strings";
	}
	...
	public void changeLanguage(IBikePreferences.Language lng) {
		clearMap();
